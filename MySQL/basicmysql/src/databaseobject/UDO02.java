 ...
 *
 * 【存储函数】mySQL支持自定义函数，定义好之后，调用方式与调用MySQL预定义的系统函数一样
 ...
 *       它不适合高并发的场景
 *
 * 【创建存储函数可能出现的问题】log_bin_trust_function_creators=0，因为默认不信任存储函数的创建
 *     set global log_bin_trust_function_creators=1;                   # global表示全局生效
 *
 *
 @author Alex
