...
<script type="text/javascript">
    $(function () {
        ...
        $(".updateCount").change(function () {
            ...
            //发起请求。给服务器保存修改
                location.href ="http://localhost:8080/project_book/cartServlet?action=updateCount&count="+count+"&id="+id;
            } else {
        ...
        <c:if test="${not empty sessionScope.cart.items}">
            <c:forEach items="${sessionScope.cart.items}" var="entry">
                <tr>
                    ...
                    <td>
                        <input type="text" class="updateCount" style="width: 80px" bookId="${entry.value.id}" value="${entry.value.count}">
                    </td>
