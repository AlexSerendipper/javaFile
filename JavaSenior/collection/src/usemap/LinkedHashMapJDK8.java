...
//     */
//
//    // ==>(3)新造了内部类Entry的对象,该Entry对象继承自Node，实现了双向链表before after。  end
...
//
//
//    // ==>(2)重写了newNode方法，新造了内部类Entry的对象,该Entry对象继承自Node，实现了双向链表，所以就可以根据添加的顺序实现遍历end
...
//        // ==>(1). 调用其父类的构造方法。 ==>查看HashMap中的put ==>putval
//        // ==>(2)其中调用的newNode在LinkedHashMap中重写了
//
//        super();
//        accessOrder = false;
//    }
