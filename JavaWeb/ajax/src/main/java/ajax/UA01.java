...
---------------
 *  String s = JSONObject.toJSONString(Human);                           # 将javabean对象转换为json格式的字符串
 *  Human h = JSONObject.parseObject(s,Human.class)                      # 将json格式的字符串转换回javabean对象
 @author Alex
