 ...
 *
 * 【var&let】
 *  let 和 var 都可以用来声明变量，包括对象。
 * 区别是var 声明的变量具有函数作用域或全局作用域，这意味着 var 声明的变量在整个函数内都是可见的，即使它们是在代码块（如 if 或 for 语句）中声明的。
 * let 声明的变量具有块级作用域，这意味着 let 声明的变量只在声明它们的代码块内是可见的。
 @author Alex
