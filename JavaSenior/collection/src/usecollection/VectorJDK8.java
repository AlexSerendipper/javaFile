...
//     */
//
//    // ==>(3)第一次添加，minCapacity=1
//    private void ensureCapacityHelper(int minCapacity) {
//        // overflow-conscious code
//        // ==>(4)加到第11个数据时， 11-10>0，进行扩容
...
//        // overflow-conscious code
//        int oldCapacity = elementData.length;  //
//        int newCapacity = oldCapacity + ((capacityIncrement > 0) ?  // capacityIncrement初始值为0
//                                         capacityIncrement : oldCapacity);  // 所以返回oldCapacity，所以vector默认扩容为原来的二倍
//        // 特殊情况，暂不研究了
